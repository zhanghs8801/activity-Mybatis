...
(function(b) { b.color = {};
    b.color.make = function(d, e, g, f) {
        ...
        c.toString = function() {
            if (c.a >= 1) {
                return "rgb(" + [c.r, c.g, c.b].join(",") + ")" } else {
    ...
    b.color.extract = function(d, e) {
        ...
        do { c = d.css(e).toLowerCase();
            if (c != "" && c != "transparent") {
                break }
            d = d.parent() } while (!b.nodeName(d.get(0), "body"));
    ...
    b.color.parse = function(c) {
        ...
        if (e == "transparent") {
            return f(255, 255, 255, 0) } else { d = a[e] || [0, 0, 0];
    ...
    function b(av, ai, J, af) {
        ...
        aq.getAxes = function() {
            ...
            c.each(p.concat(aw), function(aD, aE) {
                if (aE) { aC[aE.direction + (aE.n != 1 ? aE.n : "") + "axis"] = aE } });
            return aC };
        ...
        function Z(aC) {
            ...
            for (var aD in ak) {
                if (O.hooks[aD] && O.hooks[aD].length) { ak[aD] = ak[aD].concat(O.hooks[aD]) } }
        ...
        function C(aE) {
            var aC = {},
                aB, aD;
            for (aB = 0; aB < p.length; ++aB) { aD = p[aB];
                if (aD && aD.used) { aC["x" + aD.n] = aD.c2p(aE.left) } }
            for (aB = 0; aB < aw.length; ++aB) { aD = aw[aB];
        ...
        function V(aC, aB) {
            if (!aC[aB - 1]) { aC[aB - 1] = { n: aB, direction: aC == p ? "x" : "y", options: c.extend(true, {}, aC == p ? O.xaxis : O.yaxis) } }
            return aC[aB - 1] }
        ...
        function ax() {
            ...
            var aH = 0,
                aN;
            for (aG = 0; aG < Q.length; ++aG) { aN = Q[aG];
                if (aN.color == null) { aN.color = aC[aH].toString();++aH } else {
                    if (typeof aN.color == "number") { aN.color = aC[aN.color].toString() } }
                if (aN.lines.show == null) {
                    var aL, aK = true;
                    for (aL in aN) {
                        if (aN[aL] && aN[aL].show) { aK = false;
                            break } }
        ...
        function z() {
            ...
            c.each(m(), function(a1, a2) { a2.datamin = aO;
                a2.datamax = aI;
                a2.used = false });
            for (aU = 0; aU < Q.length; ++aU) { aJ = Q[aU];
            ...
            for (aU = 0; aU < Q.length; ++aU) { aJ = Q[aU];
                ...
                for (aS = aR = 0; aS < aZ.length; ++aS, aR += aP) { aL = aZ[aS];
                    var aE = aL == null;
                    if (!aE) {
                        for (aN = 0; aN < aP; ++aN) { a0 = aL[aN];
                            aX = aW[aN];
                            if (aX) {
                                if (aX.number && a0 != null) { a0 = +a0;
                                    if (isNaN(a0)) { a0 = null } else {
                                        if (a0 == Infinity) { a0 = aB } else {
                                            if (a0 == -Infinity) { a0 = -aB } } } }
                                if (a0 == null) {
                                    if (aX.required) { aE = true }
                                    if (aX.defaultValue != null) { a0 = aX.defaultValue } } }
                            aT[aR + aN] = a0 } }
                    if (aE) {
                        for (aN = 0; aN < aP; ++aN) { a0 = aT[aR + aN];
                            if (a0 != null) { aX = aW[aN];
        ...
        function ah() {
            if (O.grid.hoverable) { y.mousemove(aa);
                y.mouseleave(l) }
        ...
        function r(aG) {
            ...
            if (aD == aC) { aG.p2c = function(aH) {
                    return (aH - aB) * aF } } else { aG.p2c = function(aH) {
                    return (aD(aH) - aB) * aF } }
            if (!aE) { aG.c2p = function(aH) {
                    return aB + aH / aF } } else { aG.c2p = function(aH) {
                    return aE(aB + aH / aF) } } }
        ...
        function L(aD) {
            ...
            if (aD.direction == "x") {
                ...
                if (aG == null) { aI = [];
                    for (aF = 0; aF < aJ.length; ++aF) { aE = aJ[aF].label;
        ...
        function U(aB) {
            if (aB.direction == "x") { aB.box.left = q.left;
        ...
        function n(aE) {
            ...
            if (aH == 0) {
                ...
                if (aF.max == null || aF.min != null) { aB += aC } } else {
                var aG = aF.autoscaleMargin;
                if (aG != null) {
                    if (aF.min == null) { aD -= aH * aG;
        ...
        function S(aG) {
            ...
            if (aM.mode == "time") {
                ...
                if (aM.minTickSize != null) {
                    if (typeof aM.tickSize == "number") { aC = aM.tickSize } else { aC = aM.minTickSize[0] * aJ[aM.minTickSize[1]] } }
                ...
                aB = function(aX) {
                    ...
                    do { aY = a4;
                        ...
                        a2.push(a4);
                        if (a3 == "month") {
                            if (a0 < 1) { a1.setUTCDate(1);
                                var aV = a1.getTime();
                                a1.setUTCMonth(a1.getUTCMonth() + 1);
                                var aZ = a1.getTime();
                                a1.setTime(a4 + a5 * aJ.hour + (aZ - aV) * a0);
                                a5 = a1.getUTCHours();
                                a1.setUTCHours(0) } else { a1.setUTCMonth(a1.getUTCMonth() + a0) } } else {
                            if (a3 == "year") { a1.setUTCFullYear(a1.getUTCFullYear() + a0) } else { a1.setTime(a4 + aW) } } } while (a4 < aX.max && a4 != aY);
                    return a2 };
                aR = function(aV, aY) {
                    var a0 = new Date(aV);
                    ...
                    if (aW < aJ.minute) { fmt = "%h:%M:%S" + aZ } else {
                        if (aW < aJ.day) {
                            if (aX < 2 * aJ.day) { fmt = "%h:%M" + aZ } else { fmt = "%b %d %h:%M" + aZ } } else {
                            if (aW < aJ.month) { fmt = "%b %d" } else {
                                if (aW < aJ.year) {
                                    if (aX < aJ.year) { fmt = "%b" } else { fmt = "%b %y" } } else { fmt = "%y" } } } }
                    return c.plot.formatDate(a0, fmt, aM.monthNames) } } else {
                ...
                if (aI < 1.5) { aO = 1 } else {
                    if (aI < 3) { aO = 2;
                        if (aI > 2.25 && (aU == null || aP + 1 <= aU)) { aO = 2.5;++aP } } else {
                        if (aI < 7.5) { aO = 5 } else { aO = 10 } } }
                aO *= aQ;
                ...
                aB = function(aX) {
                    ...
                    do { aY = aV;
                        ...
                        aZ.push(aV);++aW } while (aV < aX.max && aV != aY);
                    return aZ };
                aR = function(aV, aW) {
            ...
            if (aM.alignTicksWithAxis != null) {
                ...
                if (aF && aF.used && aF != aG) {
                    ...
                    aB = function(aX) {
                        var aY = [],
                            aV, aW;
                        for (aW = 0; aW < aF.ticks.length; ++aW) { aV = (aF.ticks[aW].v - aF.min) / (aF.max - aF.min);
            ...
            aG.tickGenerator = aB;
            if (c.isFunction(aM.tickFormatter)) { aG.tickFormatter = function(aV, aW) {
                    return "" + aM.tickFormatter(aV, aW) } } else { aG.tickFormatter = aR } }
        ...
        function P(aF) {
            ...
            if (aH == null || (typeof aH == "number" && aH > 0)) { aG = aF.tickGenerator(aF) } else {
                if (aH) {
                    if (c.isFunction(aH)) { aG = aH({ min: aF.min, max: aF.max }) } else { aG = aH } } }
            var aE, aB;
            aF.ticks = [];
            for (aE = 0; aE < aG.length; ++aE) {
                ...
                if (typeof aD == "object") { aB = +aD[0];
                    if (aD.length > 1) { aC = aD[1] } } else { aB = +aD }
        ...
        function W() { H.clearRect(0, 0, G, I);
            ...
            for (var aB = 0; aB < Q.length; ++aB) { an(ak.drawSeries, [H, Q[aB]]);
                d(Q[aB]) }
            an(ak.draw, [H]);
            if (aC.show && aC.aboveData) { ac() } }
        ...
        function ac() {
            ...
            for (var aE = 0; aE < aK.length; ++aE) {
                ...
                if (aB.direction == "x") { aN = 0;
                    if (aQ == "full") { aL = (aB.position == "top" ? 0 : w) } else { aL = aG.top - q.top + (aB.position == "top" ? aG.height : 0) } } else { aL = 0;
                ...
                for (aF = 0; aF < aB.ticks.length; ++aF) {
                    ...
                    if (aB.direction == "x") { aN = aB.p2c(aO);
                        aJ = aQ == "full" ? -w : aQ;
                        if (aB.position == "top") { aJ = -aJ } } else { aL = aB.p2c(aO);
                        aP = aQ == "full" ? -h : aQ;
                        if (aB.position == "left") { aP = -aP } }
                    if (H.lineWidth == 1) {
                        if (aB.direction == "x") { aN = Math.floor(aN) + 0.5 } else { aL = Math.floor(aL) + 0.5 } }
                    H.moveTo(aN, aL);
                    H.lineTo(aN + aP, aL + aJ) }
                H.stroke() }
            ...
            for (var aD = 0; aD < aJ.length; ++aD) {
                ...
                for (var aE = 0; aE < aC.ticks.length; ++aE) {
                    ...
                    if (aC.direction == "x") { aI = "center";
                        ...
                        if (aC.position == "bottom") { aK.top = aF.top + aF.padding } else { aK.bottom = I - (aF.top + aF.height - aF.padding) } } else { aK.top = Math.round(q.top + aC.p2c(aH.v) - aC.labelHeight / 2);
            ...
            function aF(aI, aQ, aP) {
                ...
                while (true) {
                    ...
                    if (aK >= aP.max && aJ >= aP.max) { H.lineTo(aQ.p2c(aZ), aP.p2c(aP.max));
                        ...
                        continue } else {
                        if (aK <= aP.min && aJ <= aP.min) { H.lineTo(aQ.p2c(aZ), aP.p2c(aP.min));
                    ...
                    if (aK <= aJ && aK < aP.min && aJ >= aP.min) { aZ = (aP.min - aK) / (aJ - aK) * (aY - aZ) + aZ;
                        aK = aP.min } else {
                        if (aJ <= aK && aJ < aP.min && aK >= aP.min) { aY = (aP.min - aK) / (aJ - aK) * (aY - aZ) + aZ;
                            aJ = aP.min } }
                    if (aK >= aJ && aK > aP.max && aJ <= aP.max) { aZ = (aP.max - aK) / (aJ - aK) * (aY - aZ) + aZ;
                        aK = aP.max } else {
                        if (aJ >= aK && aJ > aP.max && aK <= aP.max) { aY = (aP.max - aK) / (aJ - aK) * (aY - aZ) + aZ;
                            aJ = aP.max } }
        ...
        function e(aD) {
            ...
            var aE = aD.bars.fill ? function(aF, aG) {
                return ae(aD.bars, aD.color, aF, aG) } : null;
        ...
        function o() { av.find(".legend").remove();
            ...
            var aH = [],
                ...
                aM, aJ;
            for (var aE = 0; aE < Q.length; ++aE) { aM = Q[aE];
                aJ = aM.label;
                if (!aJ) {
                    continue }
            ...
            if (O.legend.container != null) { c(O.legend.container).html(aL) } else {
                ...
                if (aC.charAt(0) == "n") { aI += "top:" + (aD[1] + q.top) + "px;" } else {
                    if (aC.charAt(0) == "s") { aI += "bottom:" + (aD[1] + q.bottom) + "px;" } }
                if (aC.charAt(1) == "e") { aI += "right:" + (aD[0] + q.right) + "px;" } else {
                    if (aC.charAt(1) == "w") { aI += "left:" + (aD[0] + q.left) + "px;" } }
        ...
        function aa(aB) {
            if (O.grid.hoverable) { u("plothover", aB, function(aC) {
        ...
        function R(aB) { u("plotclick", aB, function(aC) {
        ...
        function s() { M = null;
            ...
            var aC, aB;
            for (aC = 0; aC < ab.length; ++aC) { aB = ab[aC];
        ...
        function v(aE, aB) { A.lineWidth = aE.bars.lineWidth;
            ...
            E(aB[0], aB[1], aB[2] || 0, aC, aC + aE.bars.barWidth, 0, function() {
                return aD }, aE.xaxis, aE.yaxis, A, aE.bars.horizontal, aE.bars.lineWidth) }
    ...
    c.plot.formatDate = function(l, f, h) {
        ...
        for (var g = 0; g < f.length; ++g) {
            ...
            if (p) {
                ...
                e.push(m);
                if (!j) { p = false } } else {
                if (m == "%") { p = true } else { e.push(m) } } }
        return e.join("") };

    function a(e, d) {
        return d * Math.floor(e / d) } })(jQuery);
